...
namespace UltimateXF.Widget.Charts.Models.Component
{
    public class SupportBarLineChartBase : SupportBaseChart
    {
        ...
        public static readonly BindableProperty BorderColorProperty = BindableProperty.Create("BorderColor", typeof(Color?), typeof(SupportBarLineChartBase), null);
        ...
        public static readonly BindableProperty BorderWidthProperty = BindableProperty.Create("BorderWidth", typeof(float?), typeof(SupportBarLineChartBase), null);
