        ...
        where TSupportView : SupportBarLineChartBase where TOriginalChart : BarLineChartBase
    {
        ...
        protected override void OnInitializeOriginalChartSettings()
        {
            ...
            if (SupportChartView != null && OriginalChartView != null)
            {
                ...
                if (SupportChartView.BorderColor.HasValue)
                    OriginalChartView.SetBorderColor(SupportChartView.BorderColor.Value.ToAndroid());

                if (SupportChartView.BorderWidth.HasValue)
                    OriginalChartView.SetBorderWidth(SupportChartView.BorderWidth.Value);
